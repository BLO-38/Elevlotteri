...
public class GroupingMenu3 {
    ...
    public GroupingMenu3(LinkedList<Student> st) {
        students = st;
...
//        new GroupsFrame(names, groupCount, numberCheckBox.isSelected(), enemyCount, pickUniqueGroups, scale);
            // Behåll denna new GroupsFrame(names, enemiesList, friends, groupCount, numberCheckBox.isSelected(), pickUniqueGroups, scale,genderCheckBox.isSelected());
        }
    }
